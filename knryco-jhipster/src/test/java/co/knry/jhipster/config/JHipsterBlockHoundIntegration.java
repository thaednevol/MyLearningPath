package co.knry.jhipster.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("co.knry.jhipster.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("co.knry.jhipster.security.DomainUserDetailsService", "createSpringSecurityUser");
